...
import {ReactAnimate, NavLinkAdapter} from '@app';
...
function TodoSidebarContent(props)
{
    ...
    return (
        <ReactAnimate animation="transition.slideUpIn" delay={400}>
                    ...
                    <List>
                        {folders.length > 0 && folders.map((folder) => (
                            <ListItem
                                ...
                                to={'/todo/' + folder.handle} key={folder.id}
